...
<body>
    ...
    <section class="main-heading   text-danger" id="contactus">
        ...
        <div class="text-center text-danger">
            <h1 class="display-4 text-red">Student data update Form</h1>
                ...
                <div class="col-xxl-8 col-10 col-md-8 mx-auto" style="color:black">
                    <form action="/update/{{$posts->id}}" method="post">
                        ...
                        <div class="mb-3 text-danger">
                            ...
                            <input type="text" class="form-control" id="exampleInputPassword1" name="reg"  value="{{ $posts->reg }}">
                        ...
                        <div class="mb-3 text-danger">
                            ...
                            <input type="text" class="form-control" id="exampleInputPassword1" name="fullname" value="{{ $posts->fulname }}">
                            <span style="color: red">
                                @error('fullname')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <select class="form-Seaterl form-select" id="gender" name="seater" >
                                    ...
                                    <option value="{{$posts->seater}}">Seater-2</option>
                                    <option value="{{$posts->seater}}">Seater-4</option>
                                    <option value="{{$posts->seater}}">Seater-6</option>
                                </select>
                                <span style="color: red">
                                    @error('seater')
                                        {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputPassword1" name="Roomno" value="{{ $posts->Roomno }}">
                            <span style="color: red">
                                @error('Roomno')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" name="email" autocomplete="off" value="{{ $posts->email }}">
                            <span style="color: red">
                                @error('email')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="date" name="date" value="{{ $posts->date }}">
                                <span style="color: red">
                                    @error('date')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="exampleInputPassword1" name="number"
                                    autocomplete="off" value="{{ $posts->number }}">
                                <span style="color: red">
                                    @error('number')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="exampleInputPassword1"
                                    name="Gnumber" value="{{ $posts->gnumber }}">
                                <span style="color: red">
                                    @error('Gnumber')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="exampleInputPassword1" name="address"
                                    autocomplete="off" value={{ $posts->addrss }}>
                                <span style="color: red">
                                    @error('address')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="exampleInputPassword1"
                                    name="Gaddress" autocomplete="off" value="{{ $posts->gaddrss }}">
                                <span style="color: red">
                                    @error('Gaddress')
                                        {{ $message }}
                                    @enderror
                            ...
                            <button type="submit" name="update" value="update" class="btn btn-success">Update student detail</button><br><br>
